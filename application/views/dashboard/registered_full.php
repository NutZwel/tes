...
<section class="py-4" id="preview">
  <div class="container">
    ...
    <div class="carousel position-relative" role="region" aria-label="Catalog preview">
      ...
      <div class="carousel__wrap position-relative" style="padding:0 var(--space-xl,2.5rem);overflow-x:auto;overflow-y:hidden;scrollbar-width:none;-ms-overflow-style:none;white-space:nowrap;">
