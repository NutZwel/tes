<!-- ────────────────────────────────────────────────
     ...
     Halaman form registrasi. Menampilkan card terpusat
     dengan:
       - Ikon header, judul "Create your account"
       - Alert error server-side
       - Alert error validasi
       - Field username, email, password, dan confirm-password
         (password dan confirm dibuat side-by-side)
       - Tombol submit dengan loading state
       - Link footnote ke halaman login
     ──────────────────────────────────────────────── -->
...
<section class="page page--auth">
  <div class="page__inner">
    <div class="auth-card">
      ...
      <!-- Banner error server-side (misal "Username already taken") muncul hanya jika di-set oleh controller -->
      <?php if (!empty($error)): ?>
      ...
      <?= form_open('auth/register', ['class' => 'auth-form', 'novalidate' => 'novalidate']) ?>
        ...
        <!-- Password dan confirm berdampingan untuk tata letak kompak -->
